...
const DashboardTopUI = () => {
    return (
        <>
            <Grid.Container gap={1} className={dashboardtop.wrapper}>
                <Grid xs={12} md={6}>
                    <Card className={dashboardtop.dashboardTopLeft} css={{ $$cardColor: "$colors$baseGrayColor" }}>
                        <Card.Body>
                            <Text>自己紹介</Text>
                ...
                <Grid xs={12} md={6}>
                    <Card className={dashboardtop.dashboardTopRight} css={{ $$cardColor: "$colors$baseGrayColor" }}>
                        <Card.Body>
                            ...
                            <Grid.Container gap={1} className={dashboardtop.snsContainer}>
                                <Grid xs={12} md={3}>
                                    X（旧 twitter）
                                </Grid>
                                <Grid xs={0} md={1}>
